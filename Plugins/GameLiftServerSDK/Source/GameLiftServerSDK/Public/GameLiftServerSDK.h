...
struct GAMELIFTSERVERSDK_API FStartMatchBackfillRequest
{
	...
	FStartMatchBackfillRequest(const FString& ticketId, const FString& gameSessionArn,
	                           const FString& matchmakingConfigurationArn, const TArray<FPlayer>& players) :
		m_ticketId(ticketId),
...
struct GAMELIFTSERVERSDK_API FStopMatchBackfillRequest
{
	...
	FStopMatchBackfillRequest(const FString& ticketId, const FString& gameSessionArn,
...
public:
	...
	virtual FGameLiftDescribePlayerSessionsOutcome DescribePlayerSessions(
		const FGameLiftDescribePlayerSessionsRequest& describePlayerSessionsRequest);
