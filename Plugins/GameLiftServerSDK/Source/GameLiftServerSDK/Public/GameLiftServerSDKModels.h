...
using FGameLiftGenericOutcome = TGameLiftOutcome<void*, FGameLiftError>;
using FGameLiftStringOutcome = TGameLiftOutcome<FString, FGameLiftError>;
using FGameLiftLongOutcome = TGameLiftOutcome<long, FGameLiftError>;
using FGameLiftDescribePlayerSessionsOutcome = TGameLiftOutcome<FGameLiftDescribePlayerSessionsResult, FGameLiftError>;
using FGameLiftGetInstanceCertificateOutcome = TGameLiftOutcome<FGameLiftGetInstanceCertificateResult, FGameLiftError>;
