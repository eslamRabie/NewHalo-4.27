...
namespace Aws
{
	namespace GameLift
	{
		namespace Server
		{
			...
			using StartGameSessionFn = void(*)(Aws::GameLift::Server::Model::GameSession, void*);
			using UpdateGameSessionFn = void(*)(Aws::GameLift::Server::Model::UpdateGameSession, void*);
			using ProcessTerminateFn = void(*)(void*);
			using HealthCheckFn = bool(*)(void*);
#endif
    ...
    private:
        ...
        Aws::GameLift::Server::LogParameters m_logParameters;
			...
			public:
				...
				AWS_GAMELIFT_API int getPort() const { return m_port; }
				AWS_GAMELIFT_API Aws::GameLift::Server::LogParameters getLogParameters() const
				{
