    ...
    */
    AWS_GAMELIFT_API DescribePlayerSessionsOutcome DescribePlayerSessions(const Aws::GameLift::Server::Model::DescribePlayerSessionsRequest &describePlayerSessionsRequest);
			...
			*/
			...
			@param processParameters The parameters required to successfully run the process.
			*/
			AWS_GAMELIFT_API GenericOutcome ProcessReady(
			...
			*/
			AWS_GAMELIFT_API StartMatchBackfillOutcome StartMatchBackfill(
				const Aws::GameLift::Server::Model::StartMatchBackfillRequest& backfillMatchmakingRequest);
			...
			*/
			AWS_GAMELIFT_API GenericOutcome UpdatePlayerSessionCreationPolicy(
				Aws::GameLift::Server::Model::PlayerSessionCreationPolicy newPlayerSessionPolicy);
