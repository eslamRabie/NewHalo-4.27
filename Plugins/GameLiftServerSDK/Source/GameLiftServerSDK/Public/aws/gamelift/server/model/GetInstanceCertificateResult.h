				...
				public:
					...
					*/
					GetInstanceCertificateResult(const GetInstanceCertificateResult& other)
					{
						...
						strncpy(m_certificate_chain_path, other.m_certificate_chain_path,
						        sizeof(other.m_certificate_chain_path));
						...
						strncpy(m_root_certificate_path, other.m_root_certificate_path,
						        sizeof(other.m_root_certificate_path));
					}
