...
namespace Aws
{
	namespace GameLift
	{
		...
		*/
		...
		using GenericOutcome = Outcome<void*, GameLiftError>;
		using AwsStringOutcome = Outcome<const char*, GameLiftError>;
		using AwsLongOutcome = Outcome<long, GameLiftError>;
#endif

		using DescribePlayerSessionsOutcome = Outcome<
			Aws::GameLift::Server::Model::DescribePlayerSessionsResult, GameLiftError>;
		using StartMatchBackfillOutcome = Outcome<Aws::GameLift::Server::Model::StartMatchBackfillResult, GameLiftError>
		;
		using GetInstanceCertificateOutcome = Outcome<
			Aws::GameLift::Server::Model::GetInstanceCertificateResult, GameLiftError>;
	} // namespace GameLift
} // namespace Aws
