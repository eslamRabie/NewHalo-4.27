		...
		namespace Internal
		{
			namespace Network
			{
				...
				public:
					...
					void OnStartGameSession(const std::string& name, const sio::message::ptr& data, bool hasAck,
					                        sio::message::list& ack_resp);
					void OnUpdateGameSession(const std::string& name, const sio::message::ptr& data, bool hasAck,
					                         sio::message::list& ack_resp);
					void OnTerminateProcess(const std::string& name, const sio::message::ptr& data, bool hasAck,
					                        sio::message::list& ack_resp);
