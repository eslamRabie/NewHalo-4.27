...
namespace Aws
{
	namespace GameLift
	{
		namespace Internal
		{
			...
			using InitSDKOutcome = Outcome<GameLiftServerState*, GameLiftError>;
#endif
    ...
    private:
        ...
        Aws::GameLift::Internal::Network::Network* m_network;
			...
			public:
				...
				virtual ~GameLiftServerState() override;
				...
				StartMatchBackfillOutcome BackfillMatchmaking(
				...
				//From Network::AuxProxyMessageHandler
				virtual void OnStartGameSession(GameSession& gameSession, sio::message::list& ack_resp) override;
				virtual void OnUpdateGameSession(UpdateGameSession& gameSession, sio::message::list& ack_resp) override;
				virtual void OnTerminateProcess(long terminationTime) override;
