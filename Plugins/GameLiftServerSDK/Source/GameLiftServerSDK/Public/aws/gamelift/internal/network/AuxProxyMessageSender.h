		...
		namespace Internal
		{
			namespace Network
			{
				...
				public:
					...
					GenericOutcome UpdatePlayerSessionCreationPolicy(std::string gameSessionId,
					                                                 std::string newPlayerSessionPolicy);
				...
				private:
					...
					void Send(google::protobuf::MessageLite* message,
					          std::function<void(sio::message::list const&)> ackFunction);
