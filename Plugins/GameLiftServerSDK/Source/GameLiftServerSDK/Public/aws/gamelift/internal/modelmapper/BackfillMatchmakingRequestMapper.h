	...
	namespace GameLift
	{
        ...
        static pbuffer::StopMatchmakingRequest* ParseFromStopMatchmakingRequest(const StopMatchBackfillRequest &request)
        {
            ...
            return event;
...
#else
					static pbuffer::BackfillMatchmakingRequest* ParseFromBackfillMatchmakingRequest(
					...
					static void ParseFromBufferedBackfillMatchmakingResponse(
						const pbuffer::BackfillMatchmakingResponse& response,
						StartMatchBackfillResult& result)
					{
						result.WithTicketId(response.ticketid().c_str());
					}

					static pbuffer::StopMatchmakingRequest* ParseFromStopMatchmakingRequest(
						const StopMatchBackfillRequest& request)
					{
						pbuffer::StopMatchmakingRequest* event = new pbuffer::StopMatchmakingRequest();
