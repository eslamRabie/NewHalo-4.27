...
#include "Network/LobbyGameSession.h"
...
ALobbyGameMode::ALobbyGameMode()
{
	...
	PlayerStateClass = ALobbyGameState::StaticClass();
...
void ALobbyGameMode::HandleStartingNewPlayer_Implementation(APlayerController* NewPlayer)
{
	...
	if (LobbyPC)
	{
		for (auto Mode : AvailableGameModes)
		{
			LobbyPC->Client_PopulateGameModesHUD(Mode.GameModeType, Mode.GameModeName);
		}
	}
}
